...
import Ticket_system.TicketSystem6;
import java.awt.*;
 ...
 * @author Franzoli
 */
public class ReceiptSystem6 extends javax.swing.JFrame {
...
public class GUIPrinter {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("RISE AND SPEAK with Marvin Brondial");
 ...
 System.out.println("Proceed to ticket");
  TicketSystem6 tks6 = new TicketSystem6(); 
        tks6.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceiptSystem6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReceiptSystem6().setVisible(true);
            }
        });
    }
