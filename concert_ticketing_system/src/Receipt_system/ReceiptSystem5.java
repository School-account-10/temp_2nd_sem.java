...
import Ticket_system.TicketSystem5;
import java.awt.*;
 ...
 * @author Franzoli
 */
public class ReceiptSystem5 extends javax.swing.JFrame {
...
public class GUIPrinter {
 ...
 System.out.println("Proceed to ticket");
  TicketSystem5 tks5 = new TicketSystem5(); 
        tks5.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceiptSystem5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReceiptSystem5().setVisible(true);
            }
        });
    }
